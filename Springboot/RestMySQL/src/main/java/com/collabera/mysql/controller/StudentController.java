...
import com.collabera.mysql.repository.StudentRepository;
...
public class StudentController {
	...
	public Student getStudent(@PathVariable String studentid) {
		...
		Optional<Student> optStudent = service.findById(Long.parseLong(studentid));
	...
	@PutMapping("/api/updatestudent/{student}")
	...
	public ResponseEntity<String> deleteStudent(@PathVariable Long studentid){
		...
		if(studentid == 1L) {
			return ResponseEntity.status(500).body("Can't delete the admin");
		} else {
